                ...
                <div className="container">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div className="page-title">
                            <h1 className="title-head text-uppercase mt-3">
                                <a href="#!"><strong>Chính sách</strong></a>
                            </h1>
                        </div>
                        <div className="content-page mb-5">
                            ...
                            <p><strong>4. Cách thức mua hàng</strong></p>
                            <p>- Đặt hàng online tại website: https://polyfood.store/</p>
                            <p>- Gọi trực tiếp đến số điện thoại: 0906077598</p>
                            <p>- Qua email: polyfood@gmail.com</p>
                            <p><strong>5. Quy định đối với sản phẩm đổi trả</strong></p>
                            <p>- Sản phẩm bị lỗi hoặc bị hư hại trong quá trình vận chuyển.</p>
                            <p>- Sản phẩm không đúng với trong đơn hàng đã đặt.</p>
                            <p>- Các trường hợp trả hàng cần nhận được thông tin hình ảnh tại thời điểm nhận hàng.</p>
                            <p>- Khách hàng liên hệ qua các kênh hotline, facebook để được hỗ trợ xử lý trong vòng 24h kể từ thời điểm nhận hàng trong giờ làm việc 8-21h hàng ngày</p>
                            <p>- Thời gian Ngay khi nhận hàng</p>
                            <p><strong>6. Quy định thanh toán và vận chuyển</strong></p>
                            <p>- Thanh toán trực tiếp tại cửa hàng của Poly Food địa chỉ Phố Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội.</p>
                            <p>- Thanh toán khi nhận hàng (Ship hàng COD)</p>
                            <p>- Thanh toán chuyển khoản</p>
                            <p>- Ngân hàng Vietcombank</p>
                            <p>- Số tài khoản: 0611001549009</p>
                            <p>- Tên chủ tài khoản: Le Van Thuan</p>
                            <p>- Khách hàng chịu cước vận chuyển theo cước của dịch vụ chuyển phát nhanh. Đối với khách hàng trong nội thành Hà Nội sẽ được miễn phí vận chuyển.</p>
                        </div>
                    </div>
                </div>
            </LayoutOne>
